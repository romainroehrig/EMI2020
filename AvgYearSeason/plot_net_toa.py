...
def generate_net_toa_yearavg(fin1, fin2, fin3, fin4, data_type, vmin, vmax):
    ...
    data_diff_rl = data_moy4 - data_moy3
    
    r = data_diff_rl + data_diff_rs
...
if __name__=="__main__":
    ...
    vmax = args.M
    data_type = args.t
    generate_net_toa_yearavg(fin1, fin2, fin3, fin4, data_type, vmin, vmax)
